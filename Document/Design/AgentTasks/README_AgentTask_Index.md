...
1. 本任务目录中的对应任务文档。
2. `../DesktopPet_FunctionalDesign.md`
3. `../Project_CodeStructure_Guidelines.md`

不建议只把完整架构文档直接丢给子 agent。完整文档适合作为背景，但任务执行时还需要明确“负责范围、不要改哪里、验收标准、模型建议”。本目录的子文档就是为派单准备的。
